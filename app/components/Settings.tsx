              ...
              <BlockStack gap="400">
                  ...
                  <BlockStack gap="100">
                    ...
                    <Text as="p" variant="bodySm" tone="subdued">
                      {hasActiveSubscription 
                        ...
                        : 'You are currently using Spector Free Plan with limited features'}
                    </Text>
                  </BlockStack>
                  {subscription ? getStatusBadge(subscription.status) : <Badge tone="info">Free Plan</Badge>}
                </InlineStack>
                ...
                <BlockStack gap="400">
                  ...
                  <InlineStack align="space-between" blockAlign="center">
                    ...
                    <Text as="p" variant="bodyMd" fontWeight="semibold">
                      {subscription ? `${formatPrice(subscription.price, subscription.currency)}/month` : 'Free'}
                    </Text>
                  </InlineStack>

                  {/* Current Period End or Plan Limits */}
                  {subscription?.currentPeriodEnd ? (
                    ...
                    <InlineStack align="space-between" blockAlign="center">
                      ...
                      <Text as="p" variant="bodyMd" fontWeight="semibold">
                        10 products • 1 forecast • 1 rule/type
                      </Text>
                    </InlineStack>
                  )}
            ...
            <Card>
              <BlockStack gap="500">
                <BlockStack gap="100">
                  ...
                  <Text as="p" variant="bodySm" tone="subdued">
                    All features available {hasActiveSubscription ? 'with your subscription' : 'on Free Plan (with limits)'}
                  </Text>
                </BlockStack>
